...
libext4 = compile(expand("extras/ext4_utils", ext4files), "-D_GNU_SOURCE -Icore/libsparse/include -Icore/include -Iextras/ext4_utils/include")

link("fastboot", libsparse + libzip + libcutils + liblog + libutil + libbase + libext4 + f2fs + libfastboot + libdiagnoseusb, "-lz -lpcre2-8 -lpthread -ldl -lselinux -lsepol")
...
e2fsdroid = compile(expand("e2fsprogs", e2fsdroidfiles), "-Ie2fsprogs/lib -Ie2fsprogs/lib/ext2fs -Icore/libcutils/include -Ie2fsprogs/misc")
