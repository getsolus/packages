...
NEW_REPO="https://cdn.getsol.us/repo/shannon/eopkg-index.xml"
...
function update_repo() {
    ...
    do
        ...
        then
            ...
            # Workaround for eopkg #149 while repos are the same.
            # Remove this when the repo is fixed.
            eopkg add-repo -y --no-fetch "${repo}" "${NEW_REPO}"
            eopkg add-repo -y "${repo}" "${NEW_REPO}.xz"
